...
msg  = '呼和浩特@Huhot@你好'
result = msg.split('@')
print(msg)  # 呼和浩特@Huhot@你好
print(result)  # ['呼和浩特', 'Huhot', '你好']
```
...
msg = 'welcome to Huhot'
result = msg.replace('Huhot', '呼和浩特')
print(msg)    # welcome to Huhot
print(result) # welcome to 呼和浩特
```
